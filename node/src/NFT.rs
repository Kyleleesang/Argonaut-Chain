...
pub trait UniqueAssets<AccountId> {
    ...
    fn transfer(_origin, dest_account: &AccountId, asset_id: &Self::AssetId) -> DispatchResult{
        ...
        let updated_to_balance = receiver_balance.checked_add(value).expect("You got a new NFT");
